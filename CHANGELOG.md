...
**新增**
1. 新增 payment 渠道demo alipay_scan、wx_pub_scan、cb_alipay、cb_wx、cb_wx_pub、cb_wx_pub_qr、cb_wx_pub_scan
...
*  查询payment列表时app[id]为必填参数

## 3.0.3
* refund对象增加Payment_order_no、Transaction_no字段
