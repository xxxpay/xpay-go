...
import (
	...
	"github.com/xxxpay/xpay-go/xpay/channel"
)
...
//创建子商户应用支付渠道
func (c *ChannelDemo) New() (*xpay.Channel, error) {
	params := &xpay.ChannelParams{
		Channel: "alipay",
...
//查询子商户应用支付渠道
func (c *ChannelDemo) Get() (*xpay.Channel, error) {
	return channel.Get(c.demoAppID, c.demoSubAppID, "alipay")
}

//更新子商户应用支付渠道
func (c *ChannelDemo) Update() (*xpay.Channel, error) {
	params := xpay.ChannelUpdateParams{
		Params: map[string]interface{}{
			"hello": "world",
		},
	}
...
//删除子商户应用支付渠道
func (c *ChannelDemo) Delete() (*xpay.ChannelDeleteResult, error) {
