...
import (
	...
	"github.com/xxxpay/xpay-go/xpay/recharegRefund"
)
...
func (c *RechargeRefundDemo) New() (*xpay.Refund, error) {
	rechargeParams := &xpay.RechargeRefundParams{
		Description: "充值退款",
	}
	return recharegRefund.New(c.demoAppID, c.demoRechargeID, rechargeParams)
}

func (c *RechargeRefundDemo) Get() (*xpay.Refund, error) {
	return recharegRefund.Get(c.demoAppID, c.demoRechargeID, c.demoRefundID)
}

func (c *RechargeRefundDemo) List() (*xpay.RefundList, error) {
