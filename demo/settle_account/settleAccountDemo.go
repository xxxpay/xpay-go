...
// 创建结算账户对象-alipay
func (c *SettleAccountDemo) New() (*xpay.SettleAccount, error) {
	//目前支持的渠道有 bank_account，alipay，wx_pub
	params := &xpay.SettleAccountParams{
...
// 查询结算账户对象
func (c *SettleAccountDemo) Get() (*xpay.SettleAccount, error) {
	return settleAccount.Get("app_1Gqj58ynP0mHeX1q", "user_004", "320217031816231000001001")
}

// 查询结算账户对象列表
func (c *SettleAccountDemo) List() (*xpay.SettleAccountList, error) {
...
//删除结算账户对象
func (c *SettleAccountDemo) Delete() (*xpay.DeleteResult, error) {
