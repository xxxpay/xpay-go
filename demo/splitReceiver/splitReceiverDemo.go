...
import (
	...
	"github.com/xxxpay/xpay-go/xpay/splitReceiver"
)
...
// Get 查询 分账接收方 对象
func (c *demo) New() (*xpay.SplitReceiver, error) {
	var params xpay.SplitReceiverParams
	params.App = c.app
...
// Get 查询 分账接收方 对象
func (c *demo) Get() (*xpay.SplitReceiver, error) {
	return splitReceiver.Get("recv_1fRbIo0jME7yuL")
}

// List 查询 分账接收方 对象列表
func (c *demo) List() (xpay.SplitReceiverList, error) {
...
func (c *demo) Delete() (*xpay.DeleteResult, error) {
