...
import (
	...
	"github.com/xxxpay/xpay-go/xpay/royaltyTransaction"
)
...
// 查询分润明细对象
func (c *RoyaltyTransactionDemo) Get() (*xpay.RoyaltyTransaction, error) {
	return royaltyTransaction.Get(c.royaltyTransactionId)
}

// 查询分润结算对象列表
func (c *RoyaltyTransactionDemo) List() (*xpay.RoyaltyTransactionList, error) {
