...
import (
	...
	"github.com/xxxpay/xpay-go/xpay/couponTemplate"
)
...
func (c *CouponTmplDemo) New() (*xpay.CouponTmpl, error) {
	params := &xpay.CouponTmplParams{
...
func (c *CouponTmplDemo) Get() (*xpay.CouponTmpl, error) {
	return couponTemplate.Get(c.demoAppID, c.demoCouponTmplID)
}

//更新 Coupon template 对象
func (c *CouponTmplDemo) Update() (*xpay.CouponTmpl, error) {
	params := &xpay.CouponTmplUpdateParams{
...
func (c *CouponTmplDemo) Delete() (*xpay.DeleteResult, error) {
	return couponTemplate.Delete(c.demoAppID, c.demoCouponTmplID)
}

//查询 Coupon template 对象列表
func (c *CouponTmplDemo) List() (*xpay.CouponTmplList, error) {
...
func (c *CouponTmplDemo) CouponList() (*xpay.CouponList, error) {
	params := &xpay.PagingParams{}
