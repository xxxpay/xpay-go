...
// 余额提现申请
func (c *WithdrawalDemo) New() (*xpay.Withdrawal, error) {
	params := &xpay.WithdrawalParams{
		User:        "user_001",
		Amount:      20000,
		User_fee:    0,
...
// 余额提现查询
func (c *WithdrawalDemo) Get() (*xpay.Withdrawal, error) {
	return withdrawal.Get(c.demoAppID, "1701611150302360654")
}

// 余额提现列表查询
func (c *WithdrawalDemo) List() (*xpay.WithdrawalList, error) {
...
// 余额提现取消
func (c *WithdrawalDemo) Cancel() (*xpay.Withdrawal, error) {
	return withdrawal.Cancel(c.demoAppID, "1701611150302360654")
}

// 余额提现确认
func (c *WithdrawalDemo) Confirm() (*xpay.Withdrawal, error) {
