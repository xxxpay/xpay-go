...
import (
	...
	"github.com/xxxpay/xpay-go/xpay/balanceBonus"
)
...
func (c *BalanceBonusDemo) New() (*xpay.BalanceBonus, error) {
	r := rand.New(rand.NewSource(time.Now().UnixNano()))
	orderno := r.Intn(999999999999999)
	params := &xpay.BalanceBonusParams{
		Amount:      1,
		User:        "demoUser",
...
//查询 balanceBonus 对象
func (c *BalanceBonusDemo) Get() (*xpay.BalanceBonus, error) {
	return balanceBonus.Get(c.demoAppID, c.demoBonusId)
}

//查询 balanceBonus 对象列表
func (c *BalanceBonusDemo) List() (*xpay.BalanceBonusList, error) {
